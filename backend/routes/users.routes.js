...
const {getUser, newUser, login, addSongToLibrary, myLikedSongs, updateUser, allUsers, updateAdminUser} = require('../controllers/usersControllers')
...
router.put('/updateAdmin/:id',protect,updateAdminUser)
